...
const About = () => {
  ...
  return (
    <section className="pt-[60px] bg-primary">
      <div className="w-full max-w-[90rem] mx-auto px-4 2xl:px-0 pt-10 md:pt-16 pb-16 text-primary-foreground">
        <div className="flex flex-col md:flex-row gap-y-6 md:gap-y-0 md:gap-x-10">
          <div className="md:w-1/2 md:justify-center flex flex-col">
            ...
            <p className="text-[16px] max-w-[35rem] lg:text-[18px] lg:leading-7">{t("about.text")}</p>
          </div>
      ...
      <AboutTeamCards />
      <div className="w-full max-w-[90rem] py-12 md:py-16 px-4 2xl:px-0 mx-auto text-primary-foreground">
